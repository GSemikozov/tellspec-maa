...
export const PDFTemplate: React.FC<PDFTemplateProps> = ({ report }) => {
    const { milk_id, created_at } = report;
    ...
    return (
        <div id={'pdf-container-milk'} className={'pdf-milk-container'}>
            <PDFCover milkID={milk_id} reportDate={created_at} />
            <div className={'pdf-milk-page'}>
                ...
                <div className={'resultContainer'}>
                    <div className={'pdf-milk-yourResult'}>Your result: {energyValue} kcal/dl</div>
                    <div className={'pdf-milk-details'}>
                        This is a measure of the energy content of the milk. The major contributors
                        are fats, carbohydrates and proteins. It is estimated that a breastfeeding
                        woman should be consuming a minimum of an extra 500 calories per day above
                        her normal baseline.
                    </div>
                </div>
                ...
                />
                <div className={'resultContainer'}>
                    <div className={'pdf-milk-yourResult'}>Your result: {proteinValue} g/dl</div>
                    <div className={'pdf-milk-details'}>
                        It is estimated that protein is responsible for 8-10% of a babys energy
                        requirements. Proteins are important for immune and neurological funtion and
                        the building blocks for tissues, muscles and bones.
                    </div>
                </div>
                <PDFFooter page={2} />
            </div>
            <div className={'pdf-milk-page'}>
                ...
                />
                <div className={'resultContainer'}>
                    <div className={'pdf-milk-yourResult'}>Your result: {fatValue} g/dl</div>
                    <div className={'pdf-milk-details'}>
                        The amount of fat in milk is contributes to your baby’s growth. It is
                        essential for the metabolism of vitamins important for neurodevelopment and
